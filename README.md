...
* **Purple/Orange:** Currently comparing/swapping
...
Would you like me to create a **GIF** or **Video** of the visualizer using the "Veo" model to include in your GitHub header as well?
